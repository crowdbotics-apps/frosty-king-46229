"""
Django settings for frosty_king_46229 project.
...
ROOT_URLCONF = 'frosty_king_46229.urls'
...
WSGI_APPLICATION = 'frosty_king_46229.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_king_46229 API",
    "DESCRIPTION": "API documentation for frosty_king_46229 App",
    "VERSION": "v1",
}
